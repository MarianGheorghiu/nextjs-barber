...
export default function RegisterBarber() {
  ...
  const validateForm = () => {
    ...
    const emailPrefixRegex = /^[a-z0-9.]+$/;
    if (!emailPrefixRegex.test(emailPrefix)) {
      return "Prefixul de email poate conține doar litere mici, cifre și punct (.).";
    }
        ...
        <div className="w-full max-w-2xl bg-white/5 backdrop-blur-2xl border border-white/20 p-8 sm:p-12 rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,0,0.5)] relative overflow-hidden">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-300 font-medium">
              Alătură-te platformei și gestionează-ți clienții.
            </p>
          </div>
          ...
          {success ? (
            <div className="text-center py-10 animate-fade-in">
              ...
              <p className="text-slate-300 mb-10 text-lg">
                Contul tău a fost înregistrat cu succes. Acum te poți
                autentifica.
              </p>
              <Link
                href="/login"
              ...
              <div className="relative group">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Ex: BarberPro Studio"
                    className="w-full bg-white/10 focus:bg-white/15 backdrop-blur-md border border-white/20 focus:border-cyan-400 rounded-2xl pl-11 pr-4 py-4 text-white placeholder:text-slate-400 outline-none transition-all shadow-inner focus:shadow-[0_0_20px_rgba(34,211,238,0.15)] font-medium text-base"
                  />
                </div>
              </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative flex items-center">
                    ...
                    <input
                      ...
                      placeholder="nume"
                      className="w-full bg-white/10 focus:bg-white/15 backdrop-blur-md border border-white/20 focus:border-cyan-400 rounded-2xl pl-11 pr-[110px] py-4 text-white placeholder:text-slate-400 outline-none transition-all shadow-inner focus:shadow-[0_0_20px_rgba(34,211,238,0.15)] font-mono text-base"
                    />
                    <span className="absolute right-4 text-cyan-400 font-bold text-sm pointer-events-none">
                      @mcorp.com
                    </span>
                  </div>
                </div>
